  ...
  render() {
    return (
      <div className='container my-3'>
        ...
        <button type="button" onClick={this.handeleNextClick} className="btn btn-dark">Next&rarr;</button>
        </div>
      </div>
    )
  }
